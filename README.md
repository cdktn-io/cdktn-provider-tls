...
# CDKTN prebuilt bindings for hashicorp/tls provider version 4.4.1

This repo builds and publishes the [Terraform tls provider](https://registry.terraform.io/providers/hashicorp/tls/4.4.1/docs) bindings for [CDK Terrain](https://cdktn.io).
...
- [Terraform tls provider](https://registry.terraform.io/providers/hashicorp/tls/4.4.1)
