...
Represents a {@link https://registry.terraform.io/providers/hashicorp/tls/4.4.1/docs/ephemeral-resources/public_key tls_public_key}.

#### Initializers <a name="Initializers" id="@cdktn/provider-tls.ephemeralTlsPublicKey.EphemeralTlsPublicKey.Initializer"></a>

```typescript
import { ephemeralTlsPublicKey } from '@cdktn/provider-tls'

new ephemeralTlsPublicKey.EphemeralTlsPublicKey(scope: Construct, id: string, config?: EphemeralTlsPublicKeyConfig)
```
...
ephemeralTlsPublicKey.EphemeralTlsPublicKey.isConstruct(x: any)
```
...
ephemeralTlsPublicKey.EphemeralTlsPublicKey.isTerraformElement(x: any)
```
...
ephemeralTlsPublicKey.EphemeralTlsPublicKey.isTerraformEphemeralResource(x: any)
```
...
| <code><a href="#@cdktn/provider-tls.ephemeralTlsPublicKey.EphemeralTlsPublicKey.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-tls.ephemeralTlsPublicKey.EphemeralTlsPublicKey.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-tls.ephemeralTlsPublicKey.EphemeralTlsPublicKey.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-tls.ephemeralTlsPublicKey.EphemeralTlsPublicKey.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-tls.ephemeralTlsPublicKey.EphemeralTlsPublicKey.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
const ephemeralTlsPublicKeyConfig: ephemeralTlsPublicKey.EphemeralTlsPublicKeyConfig = { ... }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-tls.ephemeralTlsPublicKey.EphemeralTlsPublicKeyConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-tls.ephemeralTlsPublicKey.EphemeralTlsPublicKeyConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-tls.ephemeralTlsPublicKey.EphemeralTlsPublicKeyConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tls/4.4.1/docs/ephemeral-resources/public_key#private_key_openssh EphemeralTlsPublicKey#private_key_openssh}
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/tls/4.4.1/docs/ephemeral-resources/public_key#private_key_pem EphemeralTlsPublicKey#private_key_pem}
