...
```csharp
private void ResetCaPrivateKeyPem()
```
...
```csharp
private void ResetCaPrivateKeyPemWo()
```
...
```csharp
private void ResetCaPrivateKeyPemWoVersion()
```
...
| <code><a href="#@cdktn/provider-tls.locallySignedCert.LocallySignedCert.property.caPrivateKeyPemWoVersionInput">CaPrivateKeyPemWoVersionInput</a></code> | <code>double</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-tls.locallySignedCert.LocallySignedCert.property.caPrivateKeyPemWoVersion">CaPrivateKeyPemWoVersion</a></code> | <code>double</code> | *No description.* |
...
```csharp
public string CaPrivateKeyPemWoInput { get; }
```
...
```csharp
public double CaPrivateKeyPemWoVersionInput { get; }
```
...
```csharp
public string CaPrivateKeyPemWo { get; }
```
...
```csharp
public double CaPrivateKeyPemWoVersion { get; }
```
...
new LocallySignedCertConfig {
    ...
    string CaPrivateKeyPem = null,
    string CaPrivateKeyPemWo = null,
    double CaPrivateKeyPemWoVersion = null,
...
| <code><a href="#@cdktn/provider-tls.locallySignedCert.LocallySignedCertConfig.property.caPrivateKeyPemWoVersion">CaPrivateKeyPemWoVersion</a></code> | <code>double</code> | The version of the `ca_private_key_pem_wo` write-only private key. |
...
```csharp
public string CaPrivateKeyPemWo { get; set; }
```
...
```csharp
public double CaPrivateKeyPemWoVersion { get; set; }
```
