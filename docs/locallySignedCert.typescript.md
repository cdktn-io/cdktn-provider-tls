...
```typescript
import { locallySignedCert } from '@cdktn/provider-tls'
...
```typescript
public resetCaPrivateKeyPem(): void
```
...
```typescript
public resetCaPrivateKeyPemWo(): void
```
...
```typescript
public resetCaPrivateKeyPemWoVersion(): void
```
...
| <code><a href="#@cdktn/provider-tls.locallySignedCert.LocallySignedCert.property.caPrivateKeyPemWoVersionInput">caPrivateKeyPemWoVersionInput</a></code> | <code>number</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-tls.locallySignedCert.LocallySignedCert.property.caPrivateKeyPemWoVersion">caPrivateKeyPemWoVersion</a></code> | <code>number</code> | *No description.* |
...
```typescript
public readonly caPrivateKeyPemWoInput: string;
```
...
```typescript
public readonly caPrivateKeyPemWoVersionInput: number;
```
...
```typescript
public readonly caPrivateKeyPemWo: string;
```
...
```typescript
public readonly caPrivateKeyPemWoVersion: number;
```
...
| <code><a href="#@cdktn/provider-tls.locallySignedCert.LocallySignedCertConfig.property.caPrivateKeyPemWoVersion">caPrivateKeyPemWoVersion</a></code> | <code>number</code> | The version of the `ca_private_key_pem_wo` write-only private key. |
