...
// https://registry.terraform.io/providers/hashicorp/tls/4.4.1/docs/resources/cert_request
...
export class CertRequest extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CertRequest that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tls/4.4.1/docs/resources/cert_request#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/tls/4.4.1/docs/resources/cert_request tls_cert_request} Resource
  *
  * @param scope The scope in which to define this construct
