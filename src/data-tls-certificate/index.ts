...
// https://registry.terraform.io/providers/hashicorp/tls/4.3.0/docs/data-sources/certificate
...
export class DataTlsCertificate extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTlsCertificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tls/4.3.0/docs/data-sources/certificate#import import section} in the documentation of this resource for the id to use
