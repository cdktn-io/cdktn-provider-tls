...
// https://registry.terraform.io/providers/hashicorp/tls/4.4.1/docs/data-sources/certificate
...
export class DataTlsCertificateCertificatesOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  // max_path_length - computed: true, optional: false, required: false
...
export class DataTlsCertificate extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTlsCertificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tls/4.4.1/docs/data-sources/certificate#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/tls/4.4.1/docs/data-sources/certificate tls_certificate} Data Source
  *
  * @param scope The scope in which to define this construct
