...
// https://registry.terraform.io/providers/hashicorp/tls/4.3.0/docs/data-sources/public_key
...
export class DataTlsPublicKey extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTlsPublicKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tls/4.3.0/docs/data-sources/public_key#import import section} in the documentation of this resource for the id to use
