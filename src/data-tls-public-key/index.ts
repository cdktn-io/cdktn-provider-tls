...
// https://registry.terraform.io/providers/hashicorp/tls/4.4.1/docs/data-sources/public_key
...
export class DataTlsPublicKey extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTlsPublicKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tls/4.4.1/docs/data-sources/public_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/tls/4.4.1/docs/data-sources/public_key tls_public_key} Data Source
  *
  * @param scope The scope in which to define this construct
