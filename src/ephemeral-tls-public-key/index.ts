...
// https://registry.terraform.io/providers/hashicorp/tls/4.4.1/docs/ephemeral-resources/public_key
...
export class EphemeralTlsPublicKey extends cdktn.TerraformEphemeralResource {
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/tls/4.4.1/docs/ephemeral-resources/public_key tls_public_key} Ephemeral Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options EphemeralTlsPublicKeyConfig = {}
  */
  public constructor(scope: Construct, id: string, config: EphemeralTlsPublicKeyConfig = {}) {
    super(scope, id, {
