...
// https://registry.terraform.io/providers/hashicorp/tls/4.4.1/docs/resources/locally_signed_cert
...
export class LocallySignedCert extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing LocallySignedCert that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tls/4.4.1/docs/resources/locally_signed_cert#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/tls/4.4.1/docs/resources/locally_signed_cert tls_locally_signed_cert} Resource
  *
  * @param scope The scope in which to define this construct
