...
// https://registry.terraform.io/providers/hashicorp/tls/4.4.0/docs/resources/private_key
...
export class PrivateKey extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing PrivateKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tls/4.4.0/docs/resources/private_key#import import section} in the documentation of this resource for the id to use
