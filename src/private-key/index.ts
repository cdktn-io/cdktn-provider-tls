...
// https://registry.terraform.io/providers/hashicorp/tls/4.4.1/docs/resources/private_key
...
export class PrivateKey extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing PrivateKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tls/4.4.1/docs/resources/private_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/tls/4.4.1/docs/resources/private_key tls_private_key} Resource
  *
  * @param scope The scope in which to define this construct
