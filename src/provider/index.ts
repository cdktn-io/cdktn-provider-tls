...
// https://registry.terraform.io/providers/hashicorp/tls/4.3.0/docs
...
export class TlsProvider extends cdktn.TerraformProvider {
  ...
  * @param importFromId The id of the existing TlsProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/tls/4.3.0/docs#import import section} in the documentation of this resource for the id to use
